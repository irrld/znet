...
//
// Kept out of znet/util.h, and so out of every consumer of znet.h, because
// these are the only helpers that need the system socket headers to be
// declared at all. Include it when you are working with a SocketHandle
// directly.
//
...
#endif  // ZNET_DETAIL_SOCKET_OPS_H_
